...
public class Tester {
	...
	public static void main(String[] ar) {
		...
		Word2Vec vec = WordVectorSerializer
				.readWord2VecModel("data/embedding/ko_vec_100dim_1min_" + GlobalVariables.option);
...
//		System.out.println(vec.getWordVectorMatrix("URL"));
		...
		Collection<String> lst = vec.wordsNearest("김연아/Entity", 20);
		System.out.println("10 Words closest to '김연아/Entity': " + lst);

		lst = vec.wordsNearest("임효준/Entity", 10);
