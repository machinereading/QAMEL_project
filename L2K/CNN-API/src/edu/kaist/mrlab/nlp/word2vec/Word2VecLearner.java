...
public class Word2VecLearner {
	...
	public static void main(String[] args) throws Exception {
		...
		String filePath = Paths.get("data/corpus/DS-embedding-corpus.txt").toString();
		...
		WordVectorSerializer.writeWord2VecModel(vec, new File("data/embedding/ko_vec_100dim_1min_" + GlobalVariables.option));

		// Prints out the closest 10 words to "day". An example on what to do
		// with these Word Vectors.
		Collection<String> lst = vec.wordsNearest("포천_시민축구단/Entity", 10);
		System.out.println("10 Words closest to '포천_시민축구단/Entity': " + lst);
		
		lst = vec.wordsNearest("구단/Noun", 10);
		System.out.println("10 Words closest to '구단/Noun': " + lst);

		lst = vec.wordsNearest("개발/Noun", 10);
		System.out.println("10 Words closest to '개발/Noun': " + lst);

		lst = vec.wordsNearest("닌텐도/Entity", 10);
		System.out.println("10 Words closest to '닌텐도/Entity': " + lst);

		lst = vec.wordsNearest("더불어민주당/Entity", 10);
		System.out.println("10 Words closest to '더불어민주당/Entity': " + lst);
